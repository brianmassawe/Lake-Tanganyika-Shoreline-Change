...
map.getView().fit([2905829.994011, -976138.214424, 3817116.217358, -356239.444032], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lake Tanganyika Shoreline Change (1995 - 2025)</h2>';
        return titleElement;
    })(),
